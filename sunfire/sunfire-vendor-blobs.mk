...
PRODUCT_COPY_FILES +=  \
	...
	vendor/moto/sunfire/proprietary/lib/libctest.so:system/lib/libctest.so \
	...
	vendor/moto/sunfire/proprietary/lib/libOpenSLES.so:system/lib/libOpenSLES.so \
...
PRODUCT_COPY_FILES +=  \
	...
	vendor/moto/sunfire/proprietary/etc/12m_files_copy.sh:system/etc/12m_files_copy.sh \
...
PRODUCT_COPY_FILES +=  \
	vendor/moto/sunfire/proprietary/etc/pvplayer.cfg:system/etc/pvplayer.cfg \
...
# OMX utilities
PRODUCT_COPY_FILES +=  \
	vendor/moto/sunfire/proprietary/bin/omx_tests:system/bin/omx_tests \
	vendor/moto/sunfire/proprietary/bin/omx_tests:system/bin/omx_tests
...
# WiMax
PRODUCT_COPY_FILES +=  \
	vendor/moto/sunfire/proprietary/etc/wimax/RemoteProxy.cfg:system/etc/wimax/RemoteProxy.cfg \
	vendor/moto/sunfire/proprietary/etc/wimax/certs/:system/etc/wimax/certs \
	vendor/moto/sunfire/proprietary/etc/wimax/macxvi.cfg:system/etc/wimax/macxvi.cfg \
	vendor/moto/sunfire/proprietary/etc/wimax/macxvi350.bin:system/etc/wimax/macxvi350.bin \
	vendor/moto/sunfire/proprietary/etc/wimax/mfg/:system/etc/wimax/mfg \
	vendor/moto/sunfire/proprietary/etc/wimax/wimax_oma_dm.db:system/etc/wimax/wimax_oma_dm.db \
	vendor/moto/sunfire/proprietary/etc/wimax/wimaxd.conf:system/etc/wimax/wimaxd.conf \
	vendor/moto/sunfire/proprietary/etc/wimax/certs/443b9c9f.0:system/etc/wimax/certs/443b9c9f.0 \
	vendor/moto/sunfire/proprietary/etc/wimax/certs/4ef3ec0e.0:system/etc/wimax/certs/4ef3ec0e.0 \
	vendor/moto/sunfire/proprietary/etc/wimax/certs/51023c8f.0:system/etc/wimax/certs/51023c8f.0 \
	vendor/moto/sunfire/proprietary/etc/wimax/certs/Commercial_device.pem:system/etc/wimax/certs/Commercial_device.pem \
	vendor/moto/sunfire/proprietary/etc/wimax/certs/Commercial_prv_plain_key.pem:system/etc/wimax/certs/Commercial_prv_plain_key.pem \
	vendor/moto/sunfire/proprietary/etc/wimax/certs/TestCA.pem:system/etc/wimax/certs/TestCA.pem \
	vendor/moto/sunfire/proprietary/etc/wimax/certs/e1c07118.0:system/etc/wimax/certs/e1c07118.0 \
	vendor/moto/sunfire/proprietary/etc/wimax/certs/wimax_server_root.pem:system/etc/wimax/certs/wimax_server_root.pem \
	vendor/moto/sunfire/proprietary/etc/wimax/certs/wimax_server_root_ca1.pem:system/etc/wimax/certs/wimax_server_root_ca1.pem \
	vendor/moto/sunfire/proprietary/etc/wimax/certs/wimax_server_root_ca2.pem:system/etc/wimax/certs/wimax_server_root_ca2.pem \
	vendor/moto/sunfire/proprietary/etc/wimax/certs/wimax_server_root_ca3.pem:system/etc/wimax/certs/wimax_server_root_ca3.pem \
	vendor/moto/sunfire/proprietary/etc/wimax/mfg/macxvi.cfg:system/etc/wimax/mfg/macxvi.cfg \
	vendor/moto/sunfire/proprietary/etc/wimax/mfg/macxvi350.bin:system/etc/wimax/mfg/macxvi350.bin \
	vendor/moto/sunfire/proprietary/bin/wimaxc:system/bin/wimaxc \
	vendor/moto/sunfire/proprietary/bin/wimaxd:system/bin/wimaxd \
	vendor/moto/sunfire/proprietary/lib/libwimax_jni.so:system/lib/libwimax_jni.so \
	vendor/moto/sunfire/proprietary/lib/libwimax_moto.so:system/lib/libwimax_moto.so \
	vendor/moto/sunfire/proprietary/bin/wimax_test.sh:system/bin/wimax_test.sh \
	vendor/moto/sunfire/proprietary/lib/bcmwimax.ko:system/lib/bcmwimax.ko
...
PRODUCT_COPY_FILES +=  \
	...
	vendor/moto/sunfire/proprietary/lib/libfmradio_jni.so:system/lib/libfmradio_jni.so \
		vendor/moto/sunfire/proprietary/lib/libFMRadio.so:system/lib/libFMRadio.so \
